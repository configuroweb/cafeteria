...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=categories" class="nav-item nav-home"><span class='icon-field'><i class="fa fa-list-ol "></i></span> Categorías</a>
				<a href="index.php?page=products" class="nav-item nav-home"><span class='icon-field'><i class="fa fa-list-ol "></i></span> Productos</a>
